...
/**
 * An Operation will indicate the way that an Attribute's amount value changes the user's base value of the given {@link AttributeType}. Default is {@link #ADD_NUMBER}.
 * 
 ...
 * <li><tt>base</tt> indicates the base value of this {@link AttributeType}. For example: 0.7 for a Player's MOVEMENT_SPEED.</li>
